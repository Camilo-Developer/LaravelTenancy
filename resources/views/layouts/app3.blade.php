...
<head>
    ...
    <title>@yield('title') - LCKM INNOVATY</title>
...
{{--    <div class="preloader loader flex-column justify-content-center align-items-center">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{route('app.admin.dashboard')}}" class="nav-link">Inicio</a>
            </li>
        </ul>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <a href="{{route('app.admin.dashboard')}}" class="brand-link">
            <!--
            <img src="{{--url('recursos/admin/dist/img/AdminLTELogo.png')--}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
             -->
            <span class="brand-text font-weight-light">LCKM MultiTenancy</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <li class="nav-item">
                        <a href="{{route('app.admin.dashboard')}}" class="nav-link @if($_SERVER['REQUEST_URI'] === "/app/admin/dashboard") active @endif">
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2024 <a href="#">LCKM INNOVATY</a>.</strong>
        Derechos Reservados.
